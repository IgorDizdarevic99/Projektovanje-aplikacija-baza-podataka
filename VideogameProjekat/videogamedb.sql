...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 01, 2024 at 02:31 PM
...
CREATE TABLE `admini` (
  `IDAdmina` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `admini` (`IDAdmina`, `Ime`, `Prezime`, `KorisnickoIme`, `Email`, `Sifra`) VALUES
(1, 'Marko', 'Petrović', 'admin1', 'admin1@gmail.com', 'admin1'),
(2, 'Jovan', 'Aleksić', 'admin2', 'admin2@gmail.com', 'admin2'),
(3, 'Ivan', 'Jovanović', 'admin3', 'admin3@gmail.com', 'admin3');
...
--
ALTER TABLE `admini`
  MODIFY `IDAdmina` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `onlinemecevi`
  ...
  ADD CONSTRAINT `FK_IDIgraca2` FOREIGN KEY (`IDIgraca2`) REFERENCES `igraci` (`IDIgraca`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_IDNivoa` FOREIGN KEY (`IDNivoa`) REFERENCES `nivoi` (`IDNivoa`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `pojedinacnapostignucaigraca`
  ...
  ADD CONSTRAINT `FK_IDPostignuca` FOREIGN KEY (`IDPostignuca`) REFERENCES `postignuca` (`IdPostignuca`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
